...
public class PreLoadGameCroak : MonoBehaviour
{
    ...
    private void Start()
    {
        GetComponent<CallCroakSmartContract>().getScores();
        GetComponent<CallCroakSmartContract>().getHighScores();
        GetComponent<CallCroakSmartContract>().getTotalStokenBalance();
