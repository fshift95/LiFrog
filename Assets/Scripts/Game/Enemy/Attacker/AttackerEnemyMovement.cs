...
public class AttackerEnemyMovement : MonoBehaviour
{
    ...
    private AttackerPlayerAwarenessController _AttackerPlayerAwarenessController;
    ...
    private void Awake()
    {
        ...
        _AttackerPlayerAwarenessController = GetComponent<AttackerPlayerAwarenessController>();
    ...
    {
        if (_AttackerPlayerAwarenessController.AwareOfPlayer)
        {
            _targetDirection = _AttackerPlayerAwarenessController.DirectionToPlayer;
        }
    }
